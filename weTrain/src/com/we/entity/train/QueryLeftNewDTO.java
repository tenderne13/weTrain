...
public class QueryLeftNewDTO {
	...
	public String toString() {
		return "QueryLeftNewDTO [train_no=" + train_no
				...
				+ ", day_difference=" + day_difference + ", train_class_name="
				+ train_class_name + ", lishi=" + lishi + ", canWebBuy="
				+ canWebBuy + ", lishiValue=" + lishiValue + ", yp_info="
				+ yp_info + ", control_train_day=" + control_train_day
				+ ", start_train_date=" + start_train_date + ", seat_feature="
				+ seat_feature + ", yp_ex=" + yp_ex + ", train_seat_feature="
				+ train_seat_feature + ", seat_types=" + seat_types
				+ ", location_code=" + location_code + ", from_station_no="
				+ from_station_no + ", to_station_no=" + to_station_no
				+ ", control_day=" + control_day + ", sale_time=" + sale_time
				...
				+ ", yz_num=" + yz_num + ", rz_num=" + rz_num + ", yw_num="
				+ yw_num + ", rw_num=" + rw_num + ", gr_num=" + gr_num
				+ ", zy_num=" + zy_num + ", ze_num=" + ze_num + ", tz_num="
				+ tz_num + ", gg_num=" + gg_num + ", yb_num=" + yb_num
				+ ", wz_num=" + wz_num + ", qt_num=" + qt_num + ", swz_num="
				+ swz_num + "]";
	}
}
